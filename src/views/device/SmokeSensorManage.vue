  ...
  <div class="page-container">
    ...
    <div class="content-card">
      <el-table :data="sensorData" border stripe>
        ...
        <el-table-column prop="smokeStatus" label="烟雾状态" width="120">
          <template #default="{ row }">
            <el-tag :type="row.smokeStatus === '正常' ? 'success' : 'danger'" size="small">
              {{ row.smokeStatus }}
            </el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog title="详情" v-model="showDetailDialog" width="500px">
      <el-descriptions :column="2" :data="detailData" border>
        ...
        <el-descriptions-item label="烟雾状态">
          <el-tag :type="detailData.smokeStatus === '正常' ? 'success' : 'danger'" size="small">
            {{ detailData.smokeStatus }}
          </el-tag>
