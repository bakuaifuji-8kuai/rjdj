  ...
  <div class="page-container">
    ...
    <div class="content-card">
      <el-table :data="sensorData" border stripe>
        ...
        <el-table-column prop="value" label="当前光照度(lx)" width="160">
    ...
    <el-dialog :title="dialogTitle" v-model="showDialog" width="500px">
      <el-form :model="formData" label-width="100px">
        ...
        <el-form-item label="当前光照度(lx)" prop="value">
          <el-input v-model="formData.value" placeholder="请输入光照度值" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog title="详情" v-model="showDetailDialog" width="500px">
      <el-descriptions :column="2" :data="detailData" border>
        ...
        <el-descriptions-item label="当前光照度(lx)">{{ detailData.value }}</el-descriptions-item>
        <el-descriptions-item label="状态">
          <el-tag :type="detailData.status === '在线' ? 'success' : 'danger'" size="small">
            {{ detailData.status }}
          </el-tag>
  ...
  if (editingId.value) {
    ...
    if (index !== -1) {
      sensorData.value[index] = {
        ...
        value: formData.value.value || sensorData.value[index].value,
